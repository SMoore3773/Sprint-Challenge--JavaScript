...
unisWithUni.push(graduates.filter(i => i.universities == 'uni'))
...
lowCaseAnimalNames.push(zooAnimals.map(i => i.animal_name.toLocaleLowerCase()))
...
populationTotal = zooAnimals.reduce((acc, curVal) => acc + curVal.population, 0);
